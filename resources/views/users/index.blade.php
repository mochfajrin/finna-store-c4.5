<x-app-layout>
    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-8" style="margin-top: 10vh">
        <div class="mx-auto max-w-screen-lg px-4 2xl:px-0">
            <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl md:mb-6">Profil Saya
            </h2>
                        ...
                        <div class="mb-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div class="col-span-2 sm:col-span-1">
                                <label for="full_name_info_modal"
                                    class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Nama Lengkap
                                </label>
                            ...
                            <div class="col-span-2 sm:col-span-1">
                                <label for="password_info_modal"
                                    class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Password Baru*
                                </label>
