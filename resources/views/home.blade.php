<x-app-layout title="Home">
    <section class="bg-slate-700 text-white dark:bg-gray-900">
    ...
    <section class="bg-slate-700 dark:bg-gray-800">
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <div class="text-white sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight dark:text-white">About</h2>
    ...
    <section class="bg-slate-700 text-white dark:bg-gray-900">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
                <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-white dark:text-white">Lowongan Kerja
                    Terbaru
                </h2>
            </div>
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                @foreach ($lowongans as $lowongan)
                    <div class="rounded-lg border p-6 shadow-sm border-gray-700 bg-gray-800">
                        ...
                        <div class="pt-6">
                            <a href="{{ route('lowongan.show', ['lowonganId' => $lowongan->id]) }}"
                                class="text-lg font-semibold leading-tight text-white hover:underline">
                                {{ $lowongan->judul }}
                            </a>
